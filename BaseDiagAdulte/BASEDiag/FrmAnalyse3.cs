...
namespace BASEDiagAdulte
{
    public partial class FrmAnalyse3 : FormScreen
    {
        ...
        */
        ...
        {
            string file = System.Configuration.ConfigurationManager.AppSettings["CourrierAnalyseOcclusal"];
            if (!File.Exists(file))
            {
        ...
        private void TriImg2_OnEndSaisie_1(object sender, EventArgs e)
        {

            ResumeCliniqueMgmt.resumeCl.LstPtAnalyseOccF = TriImg2.ListOfPoints;
        }

        private void TriImg3_OnEndSaisie_1(object sender, EventArgs e)
        {
