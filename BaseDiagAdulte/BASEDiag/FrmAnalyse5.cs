...
namespace BASEDiagAdulte
{
    public partial class FrmAnalyse5 : FormScreen
    {
        ...
        private void CheckDiags()
        {
            ...
            int[] AcceptedDiags = new int[] { 26, 27, 271, 272, 273, 274, 275, 276, 277, 278, 279, 280, 281, 282, 1, 28, 29, 30, 31, 32, 34, 73, 74 };
        ...
        void initDisplay()
        {
            ...
            if (ResumeCliniqueMgmt.resumeCl.Diasteme != BasCommon_BO.EntentePrealable.en_OuiNon.undefined)
                chkbxDiasteme.CheckState = (ResumeCliniqueMgmt.resumeCl.Diasteme == BasCommon_BO.EntentePrealable.en_OuiNon.Oui) ? CheckState.Checked : CheckState.Unchecked;
        ...
        private void rbPosterieur_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (chkbxDiasteme.CheckState != CheckState.Indeterminate)
                ResumeCliniqueMgmt.resumeCl.Diasteme = chkbxDiasteme.CheckState == CheckState.Checked ? BasCommon_BO.EntentePrealable.en_OuiNon.Oui : BasCommon_BO.EntentePrealable.en_OuiNon.Non;
        ...
        private void FrmAnalyse4_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (DialogResult != System.Windows.Forms.DialogResult.No)
            {
                if (ResumeCliniqueMgmt.Analyse4IsValid != "")
                {
                    ...
                    {
                        ResumeCliniqueMgmt.Analyse4AffectDefault();
                    }
        ...
        private void tbOcclusion_Scroll(object sender, EventArgs e)
        {

        }

        private void rbAnterieur_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void chkbxInterposNormal_CheckedChanged(object sender, EventArgs e)
        {
        ...
        {
            string file = System.Configuration.ConfigurationManager.AppSettings["CourrierAnalyseArcades"];
            if (!File.Exists(file))
            {
        ...
        public string GetAnalyseImageSurplomb()
        {
            ...
            TriImg3.PaintOn(g, new Rectangle(0, 0, TriImg3.Width, TriImg3.Height), true);
        ...
        public string GetAnalyseImageMax()
        {
            ...
            Graphics g = Graphics.FromImage(bmp);
            TriImg1.PaintOn(g, new Rectangle(0, 0, TriImg1.Width, TriImg1.Height), true);
        ...
        private void chkbxDiasteme_MouseDown(object sender, MouseEventArgs e)
        {
            if (((CheckBox)sender).CheckState == CheckState.Indeterminate)
                ((CheckBox)sender).CheckState = CheckState.Unchecked;
        }

        private void chkbxDiasteme_MouseUp(object sender, MouseEventArgs e)
        {
            rbPosterieur_CheckedChanged(sender, new EventArgs());
        }

        private void chkBxDDD_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void rbFormeU_CheckedChanged(object sender, EventArgs e)
        {
