...
namespace BASEDiag.Ctrls
{
    ...
    public partial class DEPCtrl : UserControl
    {
        ...
        private BasCommon_BO.EntentePrealable _entente;
        public BasCommon_BO.EntentePrealable entente
        {
            get
            {
                return _entente;
        ...
        private void InitDisplay()
        {
            ...
            lblDateDuJour.Text = DateTime.Now.ToShortDateString();


            cbxPraticien.SelectedItem = _entente.Praticien;
            ...
            try
            {
                dtpDateNaissance.Value = _entente.patient.DateNaissance;
            }
        ...
        public void BuildEntente()
        {
            ...
            if (chkbxSensSagittalBasalMaxPro.Checked)
                ...
                if (chkbxSensSagittalBasalMaxRetro.Checked)
                    ...
                    _entente.SensSagittalBasalMax = EntentePrealable.en_ProRetro.Normo;
            ...
            if (chkbxSensSagittalBasalMandPro.Checked)
                ...
                if (chkbxSensSagittalBasalMandretro.Checked)
                    ...
                    _entente.SensSagittalBasalMand = EntentePrealable.en_ProRetro.Normo;
            ...
            if (chkbxSensTransversalBasalMaxEndo.Checked)
                ...
                if (chkbxSensTransversalBasalMaxExo.Checked)
                    ...
                    _entente.SensTransversalBasalMax = EntentePrealable.en_DiagOsseux.Normognatie;
            ...
            if (chkbxSensTransversalBasalMandEndo.Checked)
                ...
                if (chkbxSensTransversalBasalMandExo.Checked)
                    ...
                    _entente.SensTransversalBasalMand = EntentePrealable.en_DiagOsseux.Normognatie;
            ...
            if (chkbxSensVerticalBasalMaxHyper.Checked)
                ...
                if (chkbxSensVerticalBasalMaxHypo.Checked)
                    ...
                    _entente.SensVerticalBasal = EntentePrealable.en_Divergence.Normodivergent;
            ...
            if (chkbxSensSagittalAnomalieMaxPro.Checked)
                ...
                if (chkbxSensSagittalAnomalieMaxretro.Checked)
                    ...
                    _entente.SensSagittalAlveolaireMax = EntentePrealable.en_ProRetro.Normo;
            ...
            if (chkbxSensSagittalAnomalieMandPro.Checked)
                ...
                if (chkbxSensSagittalAnomalieMandRetro.Checked)
                    ...
                    _entente.SensSagittalAlveolaireMand = EntentePrealable.en_ProRetro.Normo;
            ...
            if (chkbxSensTransversalAnomalieMaxEndo.Checked)
                ...
                if (chkbxSensTransversalAnomalieMaxExo.Checked)
                    ...
                    _entente.SensTransversalAlveolaireMax = EntentePrealable.en_DiagAlveolaire.Normoalveolie;
            ...
            if (chkbxSensTransversalAnomalieMandEndo.Checked)
                ...
                if (chkbxSensTransversalAnomalieMandExo.Checked)
                    ...
                    _entente.SensTransversalAlveolaireMand = EntentePrealable.en_DiagAlveolaire.Normoalveolie;
            ...
            if (chkbxSensVerticalAnomalieInfra.Checked)
                ...
                if (chkbxSensVerticalAnomalieSupra.Checked)
                    ...
                    _entente.SensVerticalAlveolaire = EntentePrealable.en_OccFace.Normal;
        ...
        private void cbxFacteurFonctionnel_SelectedIndexChanged(object sender, EventArgs e)
        {
