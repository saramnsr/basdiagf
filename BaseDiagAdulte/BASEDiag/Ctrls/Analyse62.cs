...
namespace BASEDiagAdulte.Ctrls
{
    public partial class Analyse62 : ImageCtrlAgg, IAnalyse
    {
        ...
        public void ReinitRotationAuto() {
            ...
            {
                float angle = BASEDiagAdulte.Ctrls.GeomTools.AngleOfView(ListOfPoints[Po].Pt,
                                                                   ListOfPoints[Or].Pt,
        ...
        public Analyse62()
        {
            ...
            _ListOfPoints.Add(new PointToTake("Jonction Email/Gencive Inc Sup"));
            _ListOfPoints.Add(new PointToTake("Bord Occlusal Inc Sup"));
        ...
        private void Analyse62_Load(object sender, EventArgs e)
        {
