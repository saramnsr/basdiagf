...
namespace BASEDiagAdulte
{
    public partial class FrmSpecialistes : Form
    {
        ...
        private void FrmSpecialistes_Load(object sender, EventArgs e)
        {
            ...
            if (File.Exists(courierpardefautfile))
        ...
        private void AddCourrierAttributs(Correspondant Praticien, Correspondant c)
        {
            ...
            //BASEDiag_BL.OLEAccess.BASLetter.AddAttribut("SoldePatient", CurrentPatient.Solde==null?"": CurrentPatient.Solde.Value.ToString("0.0"));
            ...
            BASEDiag_BL.OLEAccess.BASLetter.AddAttribut("PlanDeTraitement", comment.comment);
        }
