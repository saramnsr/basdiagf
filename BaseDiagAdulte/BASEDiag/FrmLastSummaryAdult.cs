...
{
    public partial class FrmLastSummaryAdult : Form
    {
        ...
        public FrmLastSummaryAdult(basePatient patient, int screenidx,InvisalignAccount compteinvisalign)
        {
        ...
        public string GetAnalyseImage()
        {
            ...
            analyseForIlmpression.PaintOn(g, new Rectangle(0, 0, analyseForIlmpression.Width, analyseForIlmpression.Height), false);
        ...
        private void FrmLastSummary_Load(object sender, EventArgs e)
        {
            ...
            /////
            anOccDroit1.loadRadio(ResumeCliniqueMgmt.resumeCl.Img_Int_Droit);
            anOccFace1.loadRadio(ResumeCliniqueMgmt.resumeCl.Img_Int_Face);
            anOccGauche1.loadRadio(ResumeCliniqueMgmt.resumeCl.Img_Int_Gauche);
            anSourire1.loadRadio(ResumeCliniqueMgmt.resumeCl.Img_Ext_Sourire);

            anOccDroit1.zoomAuto();
            anOccDroit1.Center();
            anOccDroit1.ListOfPoints = ResumeCliniqueMgmt.resumeCl.LstPtAnalyseOccD;
            anOccFace1.zoomAuto();
            anOccFace1.Center();
            anOccFace1.ListOfPoints = ResumeCliniqueMgmt.resumeCl.LstPtAnalyseOccF;
            anOccGauche1.zoomAuto();
            anOccGauche1.Center();
            anOccGauche1.ListOfPoints = ResumeCliniqueMgmt.resumeCl.LstPtAnalyseOccG;
...
Restant à Votre disposition et vous souhaitant une excellente journée,";
        ...
        //bouton devis a supprimer pour v vendable
      ...
      //  {
        ...
        {
            List<CommonObjectifFromDiag> lst = CommonDiagnosticsMgmt.getCommonObjectifs(ResumeCliniqueMgmt.resumeCl.diagnostics);
        ...
        private void pbxRadio_Load(object sender, EventArgs e)
        {
