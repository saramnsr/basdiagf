...
namespace BASEDiagAdulte
{
    public partial class FrmLittleWizard : Form
    {
        ...
        public FrmLittleWizard(CommonDiagnostic diagnostic,basePatient pat)
        {
            ...
            List<CommonObjectifFromDiag> lstobjs = CommonDiagnosticsMgmt.getCommonObjectifs(diagnostic);
           ...
           int s = lstBxObjectifs.Items.Count;
        ...
        private void FrmLittleWizard_FormClosing(object sender, FormClosingEventArgs e)
        {
            foreach (Control ctrl in pnlBtns.Controls)
            {
