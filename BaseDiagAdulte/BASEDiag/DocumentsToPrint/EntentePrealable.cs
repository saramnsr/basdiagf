...
namespace BASEDiagAdulte.DocumentsToPrint
{
    public class EntentePrealableDocument : PrintDocument
    {
        ...
        private void TestPrintVerso(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(global::BASEDiagAdulte.Properties.Resources.DEPVerso, e.PageBounds);
        ...
        private void TestPrintRecto(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(global::BASEDiagAdulte.Properties.Resources.DEPRecto, e.PageBounds);
