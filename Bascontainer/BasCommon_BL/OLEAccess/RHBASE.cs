...
namespace OLEAccess
{
    public static class RHBASE
    {
        ...
        public static System.Diagnostics.Process GetProcess(Guid gui)
        {
            ...
            value = ConfigurationManager.AppSettings["RHBASE"];
            System.Diagnostics.Process[] prcs = System.Diagnostics.Process.GetProcessesByName("RHBas");
        ...
        public static void Rechercher(String search)
        {
            ...
            try
            {
                ...
                //Call the method
                ServerType.InvokeMember("Rechercher", BindingFlags.InvokeMethod, null, BASELaboObject, parameters);
