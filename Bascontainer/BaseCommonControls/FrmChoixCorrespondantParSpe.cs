...
{
    public partial class FrmChoixCorrespondantParSpe : Form
    {
        ...
        public FrmChoixCorrespondantParSpe()
        {
            InitializeComponent();
        ...
        private void Search()
        {
            List<baseSmallPersonne> correspondants = MgmtCorrespondants.getSmallCorrespondants(textBox1.Text, (TypePersonne)linkLabel1.Tag);
        ...
        private bool Build()
        {
            ...
            Correspondant c = MgmtCorrespondants.getCorrespondant(((baseSmallPersonne)lbxCorres.SelectedItem).Id);
            Value = c;
            return true;
        }
        ...
        private void cbxSpecialite_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void cbxSpecialite_Click(object sender, EventArgs e)
        {
        ...
        {
            FrmSpecialite frm = new FrmSpecialite();
            if (frm.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
                linkLabel1.Tag = frm.Value;
                linkLabel1.Text = frm.Value.Nom;
                Search();
            }
        }
