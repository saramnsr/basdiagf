...
namespace BaseCommonControls
{
    ...
    public partial class ChoixDents : UserControl
    {
			...
			private bool _IsMandibulaireActif = true;
			public bool IsMandibulaireActif { 			
				get
				{
					return _IsMandibulaireActif;
				}						
				set
				{
					_IsMandibulaireActif = value;
                    Invalidate();
				}
			}			
			

			private bool _IsMaxillaireActif = true;
			public bool IsMaxillaireActif { 			
				get
				{
					return _IsMaxillaireActif;
				}						
				set
				{
                    _IsMaxillaireActif = value;
                    Invalidate();
				}
			}			
        ...
        public new int Width
        {
            get
            {
                return global::BaseCommonControls.ChoixDentRsx.AdulteEnfant.Width;
            }
        ...
        public new int Height
        {
            get
            {
                return global::BaseCommonControls.ChoixDentRsx.AdulteEnfant.Height;
            }
        ...
        public void InitDents()
        {
            ...
            Dent d = new Dent();
            d.Name = "11";
            d.arcade = Dent.Arcade.Maxillaire;
            ...
            d = new Dent();
            d.Name = "31";
            d.arcade = Dent.Arcade.Mandibulaire;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Image img = global::BaseCommonControls.ChoixDentRsx.AdulteEnfant;
            ...
            if (!IsMaxillaireActif)
            {

                RectangleF rMaxillaireInactif = new RectangleF(2, 0, Width - 5, Height / 2);
                e.Graphics.FillRectangle(new SolidBrush(Color.FromArgb(128, Color.LightGray)), rMaxillaireInactif);
            }

            if (!IsMandibulaireActif)
            {

                RectangleF rMaxillaireInactif = new RectangleF(2, Height / 2, Width - 5, Height / 2);
                e.Graphics.FillRectangle(new SolidBrush(Color.FromArgb(128, Color.LightGray)), rMaxillaireInactif);
            }
        ...
        private Dent Hittest(Point p)
        {
            foreach (Dent d in Lstdents)
            {
                ...
                {
                    if ((d.arcade == Dent.Arcade.Maxillaire && IsMaxillaireActif)||
                        (d.arcade == Dent.Arcade.Mandibulaire && IsMandibulaireActif))
                        return d;
                }
            }
            return null;
        ...
        private void ChoixDents_Load(object sender, EventArgs e)
        {
