...
{
    public class ListControlTiers : PrintDocument
    {
        DataGridView _dgv;
        List<Prelevement> lstPrel = new List<Prelevement>();
        double total = 0;
        ...
        public ListControlTiers(List<Prelevement> lst)
        {
            lstPrel = lst;
            _dgv = InitDgv();
        ...
        protected override void OnPrintPage(PrintPageEventArgs e)
        {
            ...
            string Title = "Liste de contrôle des prélèvements en tiers payant";
        ...
        private DataGridView InitDgv()
        {
            ...
            foreach (Prelevement p in lstPrel)
            {
                object[] o = new object[]{
                    p.patient.ToString(),
                    p.Libelle,
                    p.Montant.ToString("C2"),
                    p.DateEcheance
                };

                total += p.echeance.Montant;
        ...
        void DrawNbLines(ref int y, PrintPageEventArgs e)
        {
            ...
            sf.LineAlignment = StringAlignment.Center;
            string Text = "Nombre de lignes : " + _dgv.RowCount.ToString();
