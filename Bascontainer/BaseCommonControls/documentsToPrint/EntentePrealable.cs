...
namespace BaseCommonControls.documentsToPrint
{
    public class EntentePrealableDocument : PrintDocument
    {
        ...
        private void TestPrintVerso(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(global::BaseCommonControls.Resource.DEPVerso, e.PageBounds);
        ...
        private void NormalPrintVerso(PrintPageEventArgs e)
        {
            ...
            CurrentEntente.patient.caisse = BasCommon_BL.CaissesManager.getCaisse(CurrentEntente.patient);
            string cstr = CurrentEntente.patient.caisse != null ? CurrentEntente.patient.caisse.Nom : "";

            e.Graphics.DrawString(CurrentEntente.ImmatAssure+"-"+cstr, ft, br, ConvertmmToPxl(new PointF(45, 18), resolution));
            ...
            e.Graphics.DrawString(CurrentEntente.DateDeCessationActivite == DateTime.MinValue ? "" : CurrentEntente.DateDeCessationActivite.ToShortDateString(), ft, br, ConvertmmToPxl(new PointF(62, 61), resolution));
        ...
        private void TestPrintRecto(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(global::BaseCommonControls.Resource.DEPRecto, e.PageBounds);
        ...
        private void NormalPrintRecto(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString(CurrentEntente.dateProposition.ToShortDateString(), ft, br, ConvertmmToPxl(new PointF(150, 285), resolution));
        }
        /*
        private void TestPrintVerso(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(global::BASEPractice.Properties.Resources.DEPVerso, e.PageBounds);
        ...
        private void TestPrintRecto(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(global::BASEPractice.Properties.Resources.DEPRecto, e.PageBounds);
    ...
    */
    ...
    public class EntentePrealableDocumentRecto : PrintDocument
    {
        ...
        private void NormalPrint(PrintPageEventArgs e)
        {
            ...
            if (CurrentEntente.SensSagittalBasalMax == ResumeClinique.en_ProRetro.Pro)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(46, 202), resolution));
            if (CurrentEntente.SensSagittalBasalMax == ResumeClinique.en_ProRetro.Retro)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(66, 202), resolution));
            if (CurrentEntente.SensSagittalBasalMand == ResumeClinique.en_ProRetro.Pro)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(84, 202), resolution));
            if (CurrentEntente.SensSagittalBasalMand == ResumeClinique.en_ProRetro.Retro)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(107, 202), resolution));

            if (CurrentEntente.SensSagittalAlveolaireMax == ResumeClinique.en_ProRetro.Pro)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(132, 202), resolution));
            if (CurrentEntente.SensSagittalAlveolaireMax == ResumeClinique.en_ProRetro.Retro)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(153, 202), resolution));
            if (CurrentEntente.SensSagittalAlveolaireMand == ResumeClinique.en_ProRetro.Pro)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(171, 202), resolution));
            if (CurrentEntente.SensSagittalAlveolaireMand == ResumeClinique.en_ProRetro.Retro)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(193, 202), resolution));


            if (CurrentEntente.SensTransversalBasalMax == ResumeClinique.en_DiagOsseux.Endognatie)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(46, 206), resolution));
            if (CurrentEntente.SensTransversalBasalMax == ResumeClinique.en_DiagOsseux.Exognatie)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(66, 206), resolution));
            if (CurrentEntente.SensTransversalBasalMand == ResumeClinique.en_DiagOsseux.Endognatie)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(84, 206), resolution));
            if (CurrentEntente.SensTransversalBasalMand == ResumeClinique.en_DiagOsseux.Exognatie)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(107, 206), resolution));

            if (CurrentEntente.SensTransversalAlveolaireMax == ResumeClinique.en_DiagAlveolaire.Endoalveolie)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(132, 206), resolution));
            if (CurrentEntente.SensTransversalAlveolaireMax == ResumeClinique.en_DiagAlveolaire.Exoalveolie)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(153, 206), resolution));
            if (CurrentEntente.SensTransversalAlveolaireMand == ResumeClinique.en_DiagAlveolaire.Endoalveolie)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(171, 206), resolution));
            if (CurrentEntente.SensTransversalAlveolaireMand == ResumeClinique.en_DiagAlveolaire.Exoalveolie)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(193, 206), resolution));


            if (CurrentEntente.SensVerticalBasal == ResumeClinique.en_Divergence.Hypodivergent)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(46, 210), resolution));
            if (CurrentEntente.SensVerticalBasal == ResumeClinique.en_Divergence.Hyperdivergent)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(84, 210), resolution));
            if (CurrentEntente.SensVerticalAlveolaire == ResumeClinique.en_OccFace.Supraclusion)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(132, 210), resolution));
            if (CurrentEntente.SensVerticalAlveolaire == ResumeClinique.en_OccFace.Infraclusion)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(171, 210), resolution));

            if (CurrentEntente.ClasseDentaireMolaire == ResumeClinique.en_Class.Class_I)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(43, 219), resolution));
            if (CurrentEntente.ClasseDentaireMolaire == ResumeClinique.en_Class.Class_II)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(56, 219), resolution));
            if (CurrentEntente.ClasseDentaireMolaire == ResumeClinique.en_Class.Class_III)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(69, 219), resolution));

            e.Graphics.DrawString(CurrentEntente.ClasseDentaireMolaireTxt.ToString(), ft, br, ConvertmmToPxl(new PointF(80, 219), resolution));


            if (CurrentEntente.ClasseDentaireCanine == ResumeClinique.en_Class.Class_I)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(145, 219), resolution));
            if (CurrentEntente.ClasseDentaireCanine == ResumeClinique.en_Class.Class_II)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(158, 219), resolution));
            if (CurrentEntente.ClasseDentaireCanine == ResumeClinique.en_Class.Class_III)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(171, 219), resolution));
            ...
            if ((CurrentEntente.occInverse == ResumeClinique.en_OccInverse.Droite) || (CurrentEntente.occInverse == ResumeClinique.en_OccInverse.Droite_Et_Gauche))
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(62, 232), resolution));

            if ((CurrentEntente.occInverse == ResumeClinique.en_OccInverse.Gauche) || (CurrentEntente.occInverse == ResumeClinique.en_OccInverse.Droite_Et_Gauche))
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(85, 232), resolution));

            if (CurrentEntente.occInverse == ResumeClinique.en_OccInverse.Anterieur)
                DrawTick(e.Graphics, ConvertmmToPxl(new PointF(110, 232), resolution));
