...
{
    public class ListControlEcheances : PrintDocument
    {
        DataGridView _dgv;
        List<Echeance> lstGpPrel = new List<Echeance>();
        double total = 0;
        ...
        public ListControlEcheances(List<Echeance> lst)
        {
            lstGpPrel = lst;
            _dgv = InitDgv();
        ...
        private DataGridView InitDgv()
        {
            ...
            dgvcol = new DataGridViewTextBoxColumn();
            dgvcol.HeaderText = "Date d'echéance";
            dgvcol.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            dgvcol.Width = 100;
            ...
            foreach (Echeance gp in lstGpPrel)
            {
                object[] o = new object[]{
                    gp.NomPatient,
                    gp.Libelle,
