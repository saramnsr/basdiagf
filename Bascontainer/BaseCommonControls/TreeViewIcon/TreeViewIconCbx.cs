...
namespace BaseCommonControls
{
    public partial class TreeViewIconCbx : UserControl
    {
        ...
        public bool Sorted
        {
            get
            {
                return SelectFrm.lstBxChoices.Sorted;
            }
            set
            {
                SelectFrm.lstBxChoices.Sorted = value;
            }
        }
        ...
        public Font Fnt
        {
            ...
            {
                _Fnt = value;
                SelectFrm.lstBxChoices.Font = _Fnt;
            }
        }
        ...
        public TreeViewIconCbx()
        {
            ...
            Font = new Font("Garamond", 12, FontStyle.Regular);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Enabled)
            {
                ...
                e.Graphics.DrawString(s, Font, new SolidBrush(ForeColor), new RectangleF(0, 0, Width, Height), sf);
            }
            else
            {
                ...
                sf.LineAlignment = StringAlignment.Center;
                string s = SelectFrm.lstBxChoices.SelectedItem == null ? "" : SelectFrm.lstBxChoices.SelectedItem.ToString();
                e.Graphics.DrawString(s, Font, new SolidBrush(Color.LightGray), new RectangleF(0, 0, Width, Height), sf);
