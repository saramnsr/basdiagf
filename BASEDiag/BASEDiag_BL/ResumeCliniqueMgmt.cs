...
namespace BASEDiag_BL
{
    public static class ResumeCliniqueMgmt
    {
        ...
        public static void Analyse2AffectDefault()
        {
            ...
            if (_resumeCl.TNL == BasCommon_BO.EntentePrealable.en_TriangleNoirLateral.undefined)
                _resumeCl.TNL = BasCommon_BO.EntentePrealable.en_TriangleNoirLateral.Aucun;
        }
        ...
        public static void Analyse3AffectDefault()
        {
            ...
            if (_resumeCl.ArticuleInvAnt == BasCommon_BO.EntentePrealable.en_OuiNon.undefined)
                _resumeCl.ArticuleInvAnt = BasCommon_BO.EntentePrealable.en_OuiNon.Non;
        ...
        public static void AnalyseFonctionnelAffectDefault()
        {
            ...
            //   _resumeCl.InterpositonLingual = BasCommon_BO.EntentePrealable.en_InterpositionLingual.posterieur;
            //if (_resumeCl.InterpositonLingual == BasCommon_BO.EntentePrealable.en_InterpositionLingual.undefined)
            //    _resumeCl.InterpositonLingual = BasCommon_BO.EntentePrealable.en_InterpositionLingual.anterieur;
            //if (_resumeCl.InterpositonLingual == BasCommon_BO.EntentePrealable.en_InterpositionLingual.undefined)
            //    _resumeCl.InterpositonLingual = BasCommon_BO.EntentePrealable.en_InterpositionLingual.AnterieurEtPosterieur;

            if (_resumeCl.Laterodeviation == BasCommon_BO.EntentePrealable.en_Laterodeviation.undefined)
                _resumeCl.Laterodeviation = BasCommon_BO.EntentePrealable.en_Laterodeviation.Fonctionnel;
            //if (_resumeCl.Laterodeviation == BasCommon_BO.EntentePrealable.en_Laterodeviation.undefined)
            //    _resumeCl.Laterodeviation = BasCommon_BO.EntentePrealable.en_Laterodeviation.RCetOIM;
            ////if (_resumeCl.Laterodeviation == BasCommon_BO.EntentePrealable.en_Laterodeviation.undefined)
            ////    _resumeCl.Laterodeviation = BasCommon_BO.EntentePrealable.en_Laterodeviation.Fonctionnel_Et_RCetOIM;
            ...
            //if (_resumeCl.FormeRespiration == BasCommon_BO.EntentePrealable.en_Respiration.undefined)
            //    _resumeCl.FormeRespiration = BasCommon_BO.EntentePrealable.en_Respiration.exclusive;
        ...
        public static bool Analyse2IsStarted
        {
            get
            {
                return ((_resumeCl.sourireDentaire != BasCommon_BO.EntentePrealable.en_SourireDentaire.undefined)
                    || (_resumeCl.DiagAlveolaire != BasCommon_BO.EntentePrealable.en_DiagAlveolaire.undefined)
                    || (_resumeCl.TNL != BasCommon_BO.EntentePrealable.en_TriangleNoirLateral.undefined)
                    );
            }
        }
        ...
        public static bool Analyse3IsStarted
        {
            get
            {
                return ((_resumeCl.ClasseMolD != BasCommon_BO.EntentePrealable.en_Class.undefined)
                    ...
                    || (_resumeCl.SautArticule != BasCommon_BO.EntentePrealable.en_OuiNon.undefined)
                    || (_resumeCl.ArticuleInvAnt != BasCommon_BO.EntentePrealable.en_OuiNon.undefined)
        ...
        public static string Analyse3IsValid
        {
            get
            {
                ...
                if (_resumeCl.ArticuleInvAnt == BasCommon_BO.EntentePrealable.en_OuiNon.undefined)
                    str += "\nArticule inverse anterieur non renseignée";
        ...
        public static string AllAnalysesAreValid
        {
            get
            {
                //return Analyse1IsValid + Analyse2IsValid + Analyse3IsValid +AnalyseFonctionnelIsValid+ Analyse4IsValid + Analyse5IsValid + Analyse6IsValid + Analyse7IsValid + Analyse8IsValid;
                return Analyse1IsValid + Analyse2IsValid + Analyse3IsValid + AnalyseFonctionnelIsValid + Analyse4IsValid + Analyse5IsValid + Analyse6IsValid + Analyse8IsValid;
            }
        }
        ...
        public static void AddAttributsToCourrier()
        {
            ...
            BASEDiag_BL.OLEAccess.BASLetter.AddAttribut("Sexe", ResumeCliniqueMgmt.resumeCl.patient.Genre == basePatient.Sexe.Feminin?"F":"M");
           ...
           BASEDiag_BL.OLEAccess.BASLetter.AddAttribut("TNL", ResumeCliniqueMgmt.resumeCl.TNL.ToString().Replace('_', ' '));
            ...
            BASEDiag_BL.OLEAccess.BASLetter.AddAttribut("ArticuleInvAnt", ResumeCliniqueMgmt.resumeCl.ArticuleInvAnt.ToString().Replace('_', ' '));
        ...
        public static string Resume
        {
            get
            {
                ...
                if ((_resumeCl.TNL != BasCommon_BO.EntentePrealable.en_TriangleNoirLateral.Aucun) && (_resumeCl.TNL != BasCommon_BO.EntentePrealable.en_TriangleNoirLateral.undefined))  
                    tmp += "\tTNL = " + _resumeCl.TNL.ToString() + "\r\r\n";
                ...
                //Analyse 3
                if (_resumeCl.ClasseMolD != BasCommon_BO.EntentePrealable.en_Class.undefined)
                    tmp += "\tUne classe Dentaire molaire droite = " + _resumeCl.ClasseMolD.ToString() + " \r\r\n";
                if (_resumeCl.ClasseMolG != BasCommon_BO.EntentePrealable.en_Class.undefined)
                    tmp += "\tUne classe Dentaire molaire gauche = " + _resumeCl.ClasseMolG.ToString() + " \r\r\n";
                if (_resumeCl.ClasseCanD != BasCommon_BO.EntentePrealable.en_Class.undefined)
                    tmp += "\tUne classe Dentaire cannine droite = " + _resumeCl.ClasseCanD.ToString() + " \r\r\n";
                if (_resumeCl.ClasseCanG != BasCommon_BO.EntentePrealable.en_Class.undefined)
                    tmp += "\tUne classe Dentaire cannine gauche = " + _resumeCl.ClasseCanG.ToString() + " \r\r\n";

                if (_resumeCl.SautArticule != BasCommon_BO.EntentePrealable.en_OuiNon.undefined)
                    tmp += "\tUn Saut d'articulé = " + _resumeCl.SautArticule.ToString() + " \r\r\n";

                if (_resumeCl.ArticuleInvAnt != BasCommon_BO.EntentePrealable.en_OuiNon.undefined)
                    tmp += "\tUn inversé d'articulé anterieur = " + _resumeCl.ArticuleInvAnt.ToString() + " \r\r\n";
        ...
        public static string GeneratePropositionDevis(basePatient patient)
        {
            ...
            foreach (CommonObjectifFromDiag obj in CommonDiagnosticsMgmt.getCommonObjectifsEnfant(resumeCl.diagnostics))
            {
...
Nous proposons de repositionner les os maxillaires et mandibulaires pour réharmoniser et rééquilibrer l'architecture osseuse du visage.";
        ...
        public static string DiagFonctionnel(bool ameliorer)
        {
            ...
            //if (_resumeCl.Laterodeviation == BasCommon_BO.EntentePrealable.en_Laterodeviation.RCetOIM)
            //    fonctionnel += ameliorer ? "\nAméliorer la  laterodeviation fonctionnet" : "\t\tNon correspondance entre realtion centréé(RC) et intercuspidation maximale(OIM)";
        ...
        public static string DiagAlveoloDentaire(bool ameliorer)
        {
           ...
           //
            ...
            //        alveolodentaire += ameliorer ? "\r\t\tAméliorer la DDD" : "DDD ";
            //    }
            //}

            //if (_resumeCl.DDM == BasCommon_BO.EntentePrealable.en_OuiNon.Oui)
            //{
            //    if (alveolodentaire == "") alveolodentaire = "\r";
            //    {
            //    alveolodentaire += ameliorer ? "\n\r\t\tAméliorer la DDM" : "DDM ";
            //    }
            ...
            //{
            //    if (alveolodentaire == "") alveolodentaire = "\t\t";
            //    alveolodentaire += ameliorer ? "\nAméliorer la DDD" :  "DDD ";
            //}

            //if (_resumeCl.DDM == BasCommon_BO.EntentePrealable.en_OuiNon.Oui)
            //{
            //    if (alveolodentaire == "") alveolodentaire = "\t\t";
            //    alveolodentaire += ameliorer ? "\nAméliorer la DDM" : "DDM ";
                                               ...
                                               float IncisiveMolaireGauche)
        {
            ...
            {
                if (EspaceDentaireBuccal > 0.85)
                {
                    resumeCl.sourireDentaire = BasCommon_BO.EntentePrealable.en_SourireDentaire.Large;
                }
                else
                {
            ...
            resumeCl.TNL = BasCommon_BO.EntentePrealable.en_TriangleNoirLateral.Aucun;

            if (IncisiveMolaireDroit < 0.85)          
                resumeCl.TNL = BasCommon_BO.EntentePrealable.en_TriangleNoirLateral.Droit;
            
            if (IncisiveMolaireGauche < 0.85)//moins de 5% de marge            
                resumeCl.TNL = resumeCl.TNL != BasCommon_BO.EntentePrealable.en_TriangleNoirLateral.Aucun ? BasCommon_BO.EntentePrealable.en_TriangleNoirLateral.Droit_Et_Gauche : BasCommon_BO.EntentePrealable.en_TriangleNoirLateral.Gauche;
        ...
        public static string tmps { get; set; }
    }
}
