...
namespace BASEDiag
{
    public partial class FrmWizardPrescription : Form
    {
        ...
        private bool Build()
        {
            ...
            //////////////////////////////Choix Traitement/////////////////////////////////////
            if (rdInvisalignAligneur.Checked)
            {
                CurrentPrescription.tpeProduct = InvisalignPrescriptionFullObj.productType.PHASE_1_ALIGNER;
                if (rbTraitementFull.Checked)
            ...
            {
                CurrentPrescription.tpePrescription = InvisalignPrescriptionFullObj.InvisalignType.Vivera;
                CurrentPrescription.tpeProduct = InvisalignPrescriptionFullObj.productType.VIVERA_RETAINERS;
            }
        ...
        {
            rbviveraRetainer.Visible = true;
            rbviveraRetainer.Checked = true;
        ...
        {
            rbviveraRetainer.Visible = false;
            rbTraitementFull.Visible = true;
            rbviveraRetainer.Checked = false;
