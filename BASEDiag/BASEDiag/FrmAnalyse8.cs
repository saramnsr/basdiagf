    ...
    public partial class FrmAnalyse8 : FormScreen
    {
       ...
       // bool IWantSynchro = true;
        ...
        public void ExportToLetter(bool DirectPrint)
        {
            ...
            string file = templateFolder + System.Configuration.ConfigurationManager.AppSettings["CourrierAnalyseCephalo"];
        ...
        public string GetAnalyseImage()
        {
            ...
            analyse71.PaintOn(g, new Rectangle(0, 0, analyse71.Width, analyse71.Height));
        ...
        private void btnEnvoie_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Bitmap bmp = new Bitmap(analyse71.Width, analyse71.Height);
                Graphics g = Graphics.FromImage(bmp);
                analyse71.DrawToBitmap(bmp, new Rectangle(0, 0, analyse71.Width, analyse71.Height));
                string f = Path.GetTempFileName();
                f = Path.GetFileNameWithoutExtension(f);
                f = f + ".jpg";
                //bmp.Save(path + "\\" + f, System.Drawing.Imaging.ImageFormat.Jpeg);
        ...
        private void analyse71_OnSaisie(object sender, EventArgs e)
        {
