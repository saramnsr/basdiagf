...
namespace BASEDiag
{
    public partial class FrmAnalyse7 : FormScreen
    {
        ...
        {
            string file = templateFolder + System.Configuration.ConfigurationManager.AppSettings["CourrierAnalyseProfil"];
        ...
        public string GetAnalyseImage()
        {
            ...
            Graphics g = Graphics.FromImage(bmp);
            ImgProfilSourire.PaintOn(g, new Rectangle(0, 0, ImgProfilSourire.Width, ImgProfilSourire.Height));
        ...
        private void CheckDiags()
        {
            ...
            int[] AcceptedDiags = new int[] { 14, 15, 16, 17, 18 };
