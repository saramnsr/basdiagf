...
namespace BASEDiag
{
    public partial class FrmLastSummary : Form
    {
        ...
        public FrmLastSummary(basePatient patient, int screenidx, InvisalignAccount compteinvisalign)
        {
...
//            if(CurrentPatient.AgeNbYears>=9)
                this.wizard = new BASEDiag.Ctrls.Ctrl9a99ans(CurrentPatient, this);
           // else
...
Restant à Votre disposition et vous souhaitant une excellente journée,";
            ...
            Bitmap bmp = new Bitmap(tableLayoutPanel2.Bounds.Width, tableLayoutPanel2.Bounds.Height);

            string tmpfile = Path.GetTempFileName();

            tableLayoutPanel2.DrawToBitmap(bmp, tableLayoutPanel2.Bounds);
            bmp.Save(tmpfile);
        ...
        private void GenerateImpressionsPatient(bool DirectPrint)
        {
            ...
            string CourriersPatient = templateFolder + System.Configuration.ConfigurationManager.AppSettings["CourriersPatient"];
        ...
        private void pnlContainerWizard_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void lnkToSmilers_Click_1(object sender, EventArgs e)
        {
            CurrentPatient.infoSmilers = SmilersMgmt.getInfoSmilers(CurrentPatient.Id);
            Browser br = new Browser(CurrentPatient);
            br.Show();
        ...
        private void pbxPano_Load(object sender, EventArgs e)
        {
