...
namespace BASEDiag
{
    ...
    public partial class FirstScreen : Form, IBasForm
    {
        ...
        private FrmLastSummary _frmLastSummary = null;
        public FrmLastSummary frmLastSummary
        {
            get
            {
        ...
        {
            BtnMasqueFacial.Image = global::BASEDiag.Properties.Resources.MasqueFacial;
            if (ResumeCliniqueMgmt.Analyse1IsStarted && ResumeCliniqueMgmt.Analyse1IsValid != "")
                BtnMasqueFacial.Image = global::BASEDiag.Properties.Resources.MasqueFacialNOK;
            if (ResumeCliniqueMgmt.Analyse1IsStarted && ResumeCliniqueMgmt.Analyse1IsValid == "")
                BtnMasqueFacial.Image = global::BASEDiag.Properties.Resources.MasqueFacialOK;


            BtnSourireFace.Image = global::BASEDiag.Properties.Resources.AnalyseSourire;
            if (ResumeCliniqueMgmt.Analyse2IsStarted && ResumeCliniqueMgmt.Analyse2IsValid != "")
                BtnSourireFace.Image = global::BASEDiag.Properties.Resources.AnalyseSourireNOK;
            if (ResumeCliniqueMgmt.Analyse2IsStarted && ResumeCliniqueMgmt.Analyse2IsValid == "")
                BtnSourireFace.Image = global::BASEDiag.Properties.Resources.AnalyseSourireOK;


            BtnOcclusal.Image = global::BASEDiag.Properties.Resources.Occlusal;
            if (ResumeCliniqueMgmt.Analyse3IsStarted && ResumeCliniqueMgmt.Analyse3IsValid != "")
                BtnOcclusal.Image = global::BASEDiag.Properties.Resources.OcclusalNOK;
            if (ResumeCliniqueMgmt.Analyse3IsStarted && ResumeCliniqueMgmt.Analyse3IsValid == "")
                BtnOcclusal.Image = global::BASEDiag.Properties.Resources.OcclusalOK;


            BtnFonctionnel.Image = global::BASEDiag.Properties.Resources.Fonctionnel;
            if (ResumeCliniqueMgmt.AnalyseFonctionnelIsStarted && ResumeCliniqueMgmt.AnalyseFonctionnelIsValid != "")
                BtnFonctionnel.Image = global::BASEDiag.Properties.Resources.FonctionnelNOK;
            if (ResumeCliniqueMgmt.AnalyseFonctionnelIsStarted && ResumeCliniqueMgmt.AnalyseFonctionnelIsValid == "")
                BtnFonctionnel.Image = global::BASEDiag.Properties.Resources.FonctionnelOK;

            BtnArcades.Image = global::BASEDiag.Properties.Resources.Arcades;
            if (ResumeCliniqueMgmt.Analyse4IsStarted && ResumeCliniqueMgmt.Analyse4IsValid != "")
                BtnArcades.Image = global::BASEDiag.Properties.Resources.ArcadesNOK;
            if (ResumeCliniqueMgmt.Analyse4IsStarted && ResumeCliniqueMgmt.Analyse4IsValid == "")
                BtnArcades.Image = global::BASEDiag.Properties.Resources.ArcadesOK;


            BtnSourires.Image = global::BASEDiag.Properties.Resources.Sourire;
            if (ResumeCliniqueMgmt.Analyse5IsStarted && ResumeCliniqueMgmt.Analyse5IsValid != "")
                BtnSourires.Image = global::BASEDiag.Properties.Resources.SourireNOK;
            if (ResumeCliniqueMgmt.Analyse5IsStarted && ResumeCliniqueMgmt.Analyse5IsValid == "")
                BtnSourires.Image = global::BASEDiag.Properties.Resources.SourireOK;


            BtnProfil.Image = global::BASEDiag.Properties.Resources.Profil;
            if (ResumeCliniqueMgmt.Analyse6IsStarted && ResumeCliniqueMgmt.Analyse6IsValid != "")
                BtnProfil.Image = global::BASEDiag.Properties.Resources.ProfilNOK;
            if (ResumeCliniqueMgmt.Analyse6IsStarted && ResumeCliniqueMgmt.Analyse6IsValid == "")
                BtnProfil.Image = global::BASEDiag.Properties.Resources.ProfilOK;


            BtnRadio.Image = global::BASEDiag.Properties.Resources.radio;
            if (ResumeCliniqueMgmt.Analyse7IsStarted && ResumeCliniqueMgmt.Analyse7IsValid != "")
                BtnRadio.Image = global::BASEDiag.Properties.Resources.RadioNOK;
            if (ResumeCliniqueMgmt.Analyse7IsStarted && ResumeCliniqueMgmt.Analyse7IsValid == "")
                BtnRadio.Image = global::BASEDiag.Properties.Resources.RadioOK;


            BtnPano.Image = global::BASEDiag.Properties.Resources.Pano;
            if (ResumeCliniqueMgmt.Analyse8IsStarted && ResumeCliniqueMgmt.Analyse8IsValid != "")
                BtnPano.Image = global::BASEDiag.Properties.Resources.PanoNOK;
            if (ResumeCliniqueMgmt.Analyse8IsStarted && ResumeCliniqueMgmt.Analyse8IsValid == "")
                BtnPano.Image = global::BASEDiag.Properties.Resources.PanoOK;
        ...
        private void btnResultat_Click(object sender, EventArgs e)
        {
            ...
            if (cancontinue)
            {
                ...
                //{
                //    frmLastSummary = new FrmLastSummary(CurrentPatient, CurrentScreenIdx);
                //    frmLastSummary.FormClosed += new FormClosedEventHandler(frmLastSummary_FormClosed);
                //}
                //frmLastSummary.Show();
                if (frmLastSummary == null)
                {
                    frmLastSummary = new FrmLastSummary(CurrentPatient, CurrentScreenIdx, CompteInvisalign);
                    frmLastSummary.FormClosed += new FormClosedEventHandler(frmLastSummary_FormClosed);
                }
                frmLastSummary.Show();
            }
        ...
        private void RefreshPatient(basePatient patient)
        {
            ...
            if (CurrentPatient.MainAdresse == null)
                MessageBox.Show("Ce patient n'a aucune adresse renseignée", "Attention", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void imgCtrl_Load(object sender, EventArgs e)
        {
