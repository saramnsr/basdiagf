...
namespace BASE_CONTACT.Ctrls.IPhoneControls.IPhoneListBox
{
    ...
    float maxFontSize, Size layoutSize, string s, Font f)
        ...
        public void Draw(Graphics g)
        {
            ...
            if (!Selected)
            {
                aGradientBrush = new LinearGradientBrush((RectangleF)rectGradient, Color.Transparent, Color.FromArgb(64, Color.White), LinearGradientMode.Vertical);

                blend = new ColorBlend();
                colors = new Color[] { Color.FromArgb(128, Color.White), Color.Transparent, Color.FromArgb(128, Color.White) };
                points = new Single[] { 0, 0.5f, 1 };
            ...
            {
                aGradientBrush = new LinearGradientBrush((RectangleF)rectGradient, Color.Transparent, Color.FromArgb(64, Color.Blue), LinearGradientMode.Vertical);

                blend = new ColorBlend();
                colors = new Color[] { Color.FromArgb(128, Color.Blue), Color.Transparent, Color.FromArgb(128, Color.Blue) };
                points = new Single[] { 0, 0.5f, 1 };
