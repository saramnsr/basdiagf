...
{
    public partial class ImageCtrlAgg : UserControl
    {
       ...
       // public int CurrentPointSynchroIdx = 0;
        ...
        Epsitec.Common.Drawing.Transform RadioTransform = new Epsitec.Common.Drawing.Transform();
        Epsitec.Common.Drawing.Transform PhotoTransform = new Epsitec.Common.Drawing.Transform();
        ...
        public void loadRadio(string imagefile)
        {
            ...
            /*
            imagefilestream = new System.IO.FileStream(imagefile, System.IO.FileMode.Open);
        ...
        public void StartSaisie()
        {
            if (_ListOfPoints.Count > 0)
            {
                CurrentPointIdx = 0;
                SaisieStarted = true;
                _currentmode = ModeSaisie.Saisie;
                ...
                //if (System.IO.File.Exists(CurrentHelpImage))
                //{
                //    HelpImage = Epsitec.Common.Drawing.Bitmap.FromFile(CurrentHelpImage).BitmapImage;
                //}
        ...
        public void StartSynchro()
        {
            ...
            //    Transparence = 1;
            //}
            //_currentmode = ModeSaisie.Synchro;
       ...
       public void PaintOn(Graphics gr, Rectangle r, bool ForImpression)
        {
            ...
            if ((!_showHelp) && (loupebmp == null))
            {
                ...
                {
                    if (this is IAnalyse)
                        ((IAnalyse)this).DrawExtraForms(AggGr, false);
        ...
        public void PaintOn(Graphics gr, Rectangle r)
        {
        ...
        public void AffectList(List<PointToTake> lst)
        {
            foreach (PointToTake ptt in lst)
            {
                foreach (PointToTake ptt2 in this.ListOfPoints)
                {
                    if (ptt2.PtName == ptt.PtName)
                    {
                        ptt2.visible = ptt.visible;
                        ptt2.Pt = new Point(ptt.Pt.X, ptt.Pt.Y);

                    }
                }
            }
            while ((CurrentPointIdx < ListOfPoints.Count) && (ListOfPoints[CurrentPointIdx].visible))
                CurrentPointIdx++;
