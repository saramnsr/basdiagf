...
namespace BASEDiag.Ctrls
{
    public static class SoundsLike
    {
        static SoundsLike()
        {
            ...
            _soundExTable.Add(new KeyValuePair<string, string>("bp", "1"));
            _soundExTable.Add(new KeyValuePair<string, string>("ckq", "2"));
            ...
            _soundExTable.Add(new KeyValuePair<string, string>("gj", "7"));
            _soundExTable.Add(new KeyValuePair<string, string>("xzs", "8"));
            _soundExTable.Add(new KeyValuePair<string, string>("fv", "9"));
        }
