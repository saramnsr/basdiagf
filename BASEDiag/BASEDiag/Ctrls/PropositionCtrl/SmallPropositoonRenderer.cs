...
{
    public class SmallPropositoonRenderer : AbstractPropositoonRenderer
    {
        ...
        public override void DrawTraitement(Graphics p_graphics, TraitementCell tc)
        {
            ...
            for (int i = 1; i < 10; i++)
            {
                ...
                Rectangle SemRect = new Rectangle(150 + tc.Bound.X + (i * tc.Bound.Height), tc.Bound.Y, tc.Bound.Height, tc.Bound.Height);
                SemRect.Inflate(-3, -3);
