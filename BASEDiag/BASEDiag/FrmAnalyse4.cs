...
namespace BASEDiag
{
    public partial class FrmAnalyse4 : FormScreen
    {
       ...
       //    ResumeCliniqueMgmt.resumeCl.SurplombValue = (int)tbSurplomb.SelectedIndex;
        ...
        private void InitLoad()
        {
           ...
           // TriImg2.TextIfNoImage = ConfigurationManager.AppSettings["Attr_Portrait"] + "," + ConfigurationManager.AppSettings["Attr_Face"];
       ...
       //     rbPosterieur_CheckedChanged(this, new EventArgs());
        ...
        public void ExportToLetter(bool DirectPrint)
        {
            ...
            string ffGauche= GetAnalyseFImage();
        ...
        private void TriImg2_MouseDoubleClick(object sender, MouseEventArgs e)
        {
