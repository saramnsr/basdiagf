...
namespace BASEDiag_DAL
{
    public class DAC
    {
        ...
        public static DataTable getObjectifsFromDiagnosticsAdulte(List<CommonDiagnostic> diags)
        {
            if (connection == null) getConnection();
        ...
        public static DataTable getObjectifsFromDiagnosticsAdulte(CommonDiagnostic diag)
        {
            if (connection == null) getConnection();
        ...
        public static DataTable getObjectifsFromDiagnosticsEnfant(List<CommonDiagnostic> diags)
        {
            if (connection == null) getConnection();
            ...
            try
            {
                ...
                selectQuery += "              SpecialInstructions, ";
                selectQuery += "              DESCRIPTION ";
                selectQuery += "       from bas_commondiag_commonobj_enfant";
        ...
        public static DataTable getObjectifsFromDiagnosticsEnfant(CommonDiagnostic diag)
        {
            if (connection == null) getConnection();
        ...
        public static DataTable getRestrictedPatients(string nom)
        {
            ...
            try
            {
                ...
                if (nom != "") selectQuery += " where   personne.TYPE_MATERIEL IS NULL AND upper(personne.per_nom) like '" + nom.ToUpper() + "%' ";
        ...
        public static DataTable getCommonDiagnostics()
        {
            ...
            try
            {
                ...
                selectQuery += " order by DisplayOrder,libelle";
        ...
        public static void InsertDiagEntentePrealable(EntentePrealable ententepre)
        {
            ...
            try
            {
                ...
                selectQuery += "   me_dysharmodd, ";
                selectQuery += "   me_facteurfonc, ";
                selectQuery += "        me_laterofonc, ";
                selectQuery += "        me_lateroRC, ";
                selectQuery += "        me_respbucc, ";
                selectQuery += "        me_respexc, ";
                selectQuery += "        me_interant, ";
                selectQuery += "        me_inters, ";
                selectQuery += "   pat_objectif_trait2, ";
                selectQuery += "   pat_objectif_comm2)";
                ...
                command.Parameters.AddWithValue("@me_laterofonc", ententepre.laterodeviationF == EntentePrealable.en_Laterodeviation.Fonctionnel);
                command.Parameters.AddWithValue("@me_lateroRC", ententepre.laterodeviationF == EntentePrealable.en_Laterodeviation.RCetOIM);
                command.Parameters.AddWithValue("@me_respbucc", ententepre.formerespiration == EntentePrealable.en_Respiration.buccale);
                command.Parameters.AddWithValue("@me_respexc", ententepre.formerespiration == EntentePrealable.en_Respiration.exclusive);
                command.Parameters.AddWithValue("@me_interant", ententepre.interposition == EntentePrealable.en_InterpositionLingual.posterieur);
                command.Parameters.AddWithValue("@me_inters", ententepre.interposition == EntentePrealable.en_InterpositionLingual.anterieur);
        ...
        public static void UpdateDiagEntentePrealable(EntentePrealable ententepre)
        {
            ...
            try
            {
                ...
                selectQuery += "    me_laterofonc = @me_laterofonc,\n";
                selectQuery += "    me_lateroRC = @me_lateroRC,\n";
                selectQuery += "    me_respbucc = @me_respbucc,\n";
                selectQuery += "    me_respexc = @me_respexc,\n";
                selectQuery += "    me_interant = @me_interant,\n";
                selectQuery += "    me_inters = @me_inters,\n";
        ...
        public static void InsertResumeClinique(ResumeClinique resume)
        {
            ...
            try
            {
               // max(Id)+1
                ...
                selectQuery += "        ArticuleInvAnt, ";
                //selectQuery += "        laterofonc, ";
                //selectQuery += "        lateroRC, ";
                //selectQuery += "        respbucc, ";
                //selectQuery += "        respexc, ";
                //selectQuery += "        interant, ";
                //selectQuery += "        inters, ";
            ...
            //    selectQuery += "        laterodeviation,";
                ...
                selectQuery += "        SYNCRO_ROTATION,SPP,";
               ...
               //electQuery += "        @laterodeviation,";
                ...
                command.Parameters.AddWithValue("@TNL", resume.TNL);
               ...
               // command.Parameters.AddWithValue("@me_laterofonc", resume.Laterodeviation);
               //command.Parameters.AddWithValue(" @me_lateroRC",resume.Laterodeviation);
               // command.Parameters.AddWithValue(" @me_respbucc",resume.FormeRespiration);
               // command.Parameters.AddWithValue("@me_respexc", resume.FormeRespiration);
               // command.Parameters.AddWithValue("@me_interant", resume.InterpositonLingual);
               // command.Parameters.AddWithValue(" @me_inters", resume.InterpositonLingual);
                ...
                command.Parameters.AddWithValue("@ArticuleInvAnt", resume.ArticuleInvAnt);
        ...
        public static void UpdateResumeClinique(ResumeClinique resume)
        {
            ...
            try
            {
                ...
                selectQuery += "    ArticuleInvAnt = @ArticuleInvAnt,";
            ...
            try
            {
              ...
              //  selectQuery += "       laterodeviation,";
               ...
               // selectQuery += "       InterpositonLingual,";
                ...
                selectQuery += "       ID_MODELE_ENTENTE,SPP";

                selectQuery += " from basediag_diagnostic";
                selectQuery += " where id_patient=@id";
                selectQuery += " order by dateresume asc";
        ...
        */
        ...
        public static DataTable getUtilisateurs()
        {
            ...
            try
            {
                ...
                selectQuery += " WHERE   p.TYPE_MATERIEL IS NULL ";
