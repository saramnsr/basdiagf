...
namespace BASEDiag_BO
{
    ...
    public class ResumeClinique
    {
        ...
        */
        ...
        private BasCommon_BO.EntentePrealable.en_SourireDentaire _sourireDentaire = BasCommon_BO.EntentePrealable.en_SourireDentaire.undefined;
        ...
        private BasCommon_BO.EntentePrealable.en_TriangleNoirLateral _TNL = BasCommon_BO.EntentePrealable.en_TriangleNoirLateral.undefined;
        public BasCommon_BO.EntentePrealable.en_TriangleNoirLateral TNL
        {
            get
            {
                return _TNL;
        ...
        private BasCommon_BO.EntentePrealable.en_OuiNon _ArticuleInvAnt = BasCommon_BO.EntentePrealable.en_OuiNon.undefined;
        public BasCommon_BO.EntentePrealable.en_OuiNon ArticuleInvAnt
        {
            get
            {
                return _ArticuleInvAnt;
            }
            set
            {
                _ArticuleInvAnt = value;
            }
        }

        private BasCommon_BO.EntentePrealable.en_OuiNon _SautArticule = BasCommon_BO.EntentePrealable.en_OuiNon.undefined;
        ...
        public string FacteurFonctionnel
        {
            get
            {
                ...
                if (Laterodeviation == BasCommon_BO.EntentePrealable.en_Laterodeviation.Fonctionnel) res.Add("Laterodeviation Foctionnel");
                if (Laterodeviation == BasCommon_BO.EntentePrealable.en_Laterodeviation.RCetOIM) res.Add("Fonctionnel et Non correspondance entre relation centrée et intercuspidation maximalee");
                if (FormeRespiration == BasCommon_BO.EntentePrealable.en_Respiration.buccale) res.Add("Respiration a tendance buccale ");
                if (FormeRespiration == BasCommon_BO.EntentePrealable.en_Respiration.exclusive) res.Add("Respiration buccale exclusive");
        ...
        //#region Analyse Fonctionnel (4)

        //private BasCommon_BO.EntentePrealable.en_Respiration _FormeRespiration4 = BasCommon_BO.EntentePrealable.en_Respiration.undefined;
        //public BasCommon_BO.EntentePrealable.en_Respiration FormeRespiration4
        //{
        //  get
        //   {
        //       return _FormeRespiration4;
        //  }
        //   set
        //   {
        //       _FormeRespiration4 = value;
        //  }
        //}

      

        //private BasCommon_BO.EntentePrealable.en_InterpositionLingual _InterpositonLingual4 = BasCommon_BO.EntentePrealable.en_InterpositionLingual.undefined;
        //public BasCommon_BO.EntentePrealable.en_InterpositionLingual InterpositonLingual
        //{
        //    get
        //    {
        //        return _InterpositonLingual4;
        //    }
        //    set
        //    {
        //        _InterpositonLingual4 = value;
        //    }
        //}
